...
class NetReviewsModel extends ObjectModel
{
    ...
    {
        $pack_review_ajax = 100;
        $this->reviews_by_page = $pack_review_ajax;
       /* No matter how many product reviews are visible, only 100 first reviews are actually displayed (both showed and hidden) on you product page, this variable should be equal or bigger than the number of reviews displayed on each page. 
        The concept of division in pack allows you not to load all your reviews at once, and make your page run faster, 
       */
    }
