				...
				<fieldset class="form-group row">
					...
					<!-- Global Rich Snippets/category Rich Snippets -->
							 <div class="form-group">
									...
									<div class="radio">
										<label>
											<input type="radio" name="netreviews_snippets_liste_produit" id="current_snippets_liste_produit_checked_1" value="1" {if ($current_snippets_liste_produit_checked eq '1')} checked="checked" {/if}> 
											Microdata - AggregateRating  
										</label>
											add <a href="javascript:categoryrs_show();"><b>personalized hook</b></a>
											<p id="show_categoryrs"></p>
									</div>
									<div class="radio">
										<label>
											<input type="radio" name="netreviews_snippets_liste_produit" id="current_snippets_liste_produit_checked_2" value="2" {if ($current_snippets_liste_produit_checked eq '2')} checked="checked" {/if}> JSON-LD - Product 
										</label>
									</div>
								</div>
							</div>
